 ...
 *   <li>{@link diagramaClasesCompleto.Clase#getInterfaces_implementadas <em>Interfaces implementadas</em>}</li>
 * </ul>
 *
...
public interface Clase extends Clasificador {
	...
	/**
	 * Returns the value of the '<em><b>Interfaces implementadas</b></em>' reference list.
	 * The list contents are of type {@link diagramaClasesCompleto.Interface}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Interfaces implementadas</em>' reference list.
	 * @see diagramaClasesCompleto.DiagramaClasesCompletoPackage#getClase_Interfaces_implementadas()
	 * @model
	 * @generated
	 */
	EList<Interface> getInterfaces_implementadas();
