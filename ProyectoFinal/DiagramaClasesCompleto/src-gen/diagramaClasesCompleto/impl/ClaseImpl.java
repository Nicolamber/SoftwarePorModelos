 ...
 *   <li>{@link diagramaClasesCompleto.impl.ClaseImpl#getInterfaces_implementadas <em>Interfaces implementadas</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClaseImpl extends ClasificadorImpl implements Clase {
	...
	/**
	 * The cached value of the '{@link #getInterfaces_implementadas() <em>Interfaces implementadas</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getInterfaces_implementadas()
	 * @generated
	 * @ordered
	 */
	protected EList<Interface> interfaces_implementadas;
	 ...
	 */
	@Override
	public EList<Interface> getInterfaces_implementadas() {
		if (interfaces_implementadas == null) {
			interfaces_implementadas = new EObjectResolvingEList<Interface>(Interface.class, this,
					DiagramaClasesCompletoPackage.CLASE__INTERFACES_IMPLEMENTADAS);
		}
		return interfaces_implementadas;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case DiagramaClasesCompletoPackage.CLASE__TIENE_ABM:
			return isTieneABM();
		case DiagramaClasesCompletoPackage.CLASE__INTERFACES_IMPLEMENTADAS:
			return getInterfaces_implementadas();
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DiagramaClasesCompletoPackage.CLASE__TIENE_ABM:
			...
			return;
		case DiagramaClasesCompletoPackage.CLASE__INTERFACES_IMPLEMENTADAS:
			getInterfaces_implementadas().clear();
			getInterfaces_implementadas().addAll((Collection<? extends Interface>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case DiagramaClasesCompletoPackage.CLASE__INTERFACES_IMPLEMENTADAS:
			return interfaces_implementadas != null && !interfaces_implementadas.isEmpty();
		}
