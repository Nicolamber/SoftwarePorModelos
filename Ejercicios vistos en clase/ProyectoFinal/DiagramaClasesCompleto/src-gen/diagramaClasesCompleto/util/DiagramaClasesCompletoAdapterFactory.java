...
public class DiagramaClasesCompletoAdapterFactory extends AdapterFactoryImpl {
	...
	protected DiagramaClasesCompletoSwitch<Adapter> modelSwitch = new DiagramaClasesCompletoSwitch<Adapter>() {
		...
		@Override
		public Adapter caseConfiguracionManager(ConfiguracionManager object) {
			return createConfiguracionManagerAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link diagramaClasesCompleto.ConfiguracionManager <em>Configuracion Manager</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createConfiguracionManagerAdapter() {
		return null;
	}
