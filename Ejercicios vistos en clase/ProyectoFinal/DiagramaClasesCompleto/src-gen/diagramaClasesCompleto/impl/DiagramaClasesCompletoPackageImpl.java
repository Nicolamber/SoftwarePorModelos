...
public class DiagramaClasesCompletoPackageImpl extends EPackageImpl implements DiagramaClasesCompletoPackage {
	 ...
	 * @generated
	 */
	private EClass configuracionManagerEClass = null;
	 ...
	 */
	@Override
	public EReference getDiagramaClases_Configuraciones_contenidas() {
	 ...
	 */
	@Override
	public EReference getClase_Interfaces_implementadas() {
	 ...
	 */
	@Override
	public EClass getConfiguracionManager() {
		return configuracionManagerEClass;
	}
	...
	public void createPackageContents() {
		...
		createEReference(diagramaClasesEClass, DIAGRAMA_CLASES__CONFIGURACIONES_CONTENIDAS);
		...
		createEReference(claseEClass, CLASE__INTERFACES_IMPLEMENTADAS);
		...
		configuracionManagerEClass = createEClass(CONFIGURACION_MANAGER);
	...
	public void initializePackageContents() {
		...
		configuracionDBEClass.getESuperTypes().add(this.getConfiguracionManager());
		configuracionDockerEClass.getESuperTypes().add(this.getConfiguracionManager());
		...
		initEReference(getDiagramaClases_Configuraciones_contenidas(), this.getConfiguracionManager(), null,
				"configuraciones_contenidas", null, 2, 2, DiagramaClases.class, !IS_TRANSIENT, !IS_VOLATILE,
		...
		initEAttribute(getClase_TieneABM(), ecorePackage.getEBoolean(), "tieneABM", null, 0, 1, Clase.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClase_Interfaces_implementadas(), this.getInterface(), null, "interfaces_implementadas", null,
				0, -1, Clase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(relacionEClass, Relacion.class, "Relacion", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRelacion_Destino(), this.getClase(), null, "destino", null, 0, 1, Relacion.class,
		...
		initEClass(realizacionEClass, Realizacion.class, "Realizacion", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRealizacion_Destino(), this.getClase(), null, "destino", null, 0, 1, Realizacion.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(configuracionManagerEClass, ConfiguracionManager.class, "ConfiguracionManager", IS_ABSTRACT,
		...
		initEAttribute(getconfiguracionDB_DbNombre(), ecorePackage.getEString(), "dbNombre", null, 0, 1,
				...
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getconfiguracionDB_DbUsuario(), ecorePackage.getEString(), "dbUsuario", null, 0, 1,
				configuracionDB.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(tipoRelacionEEnum, TipoRelacion.DEPENDENCIA);
