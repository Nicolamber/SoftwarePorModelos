...
public class PersonaPackageImpl extends EPackageImpl implements PersonaPackage {
	 ...
	 * @see persona.PersonaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static PersonaPackage init() {
		if (isInited)
			return (PersonaPackage) EPackage.Registry.INSTANCE.getEPackage(PersonaPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredPersonaPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		PersonaPackageImpl thePersonaPackage = registeredPersonaPackage instanceof PersonaPackageImpl
				? (PersonaPackageImpl) registeredPersonaPackage
				: new PersonaPackageImpl();
	 ...
	 */
	@Override
	public EReference getDiagrama_Persona() {
	 ...
	 */
	@Override
	public EAttribute getPersona_NombrePersona() {
	...
	public void createPackageContents() {
		...
		createEReference(diagramaEClass, DIAGRAMA__PERSONA);

		personaEClass = createEClass(PERSONA);
		createEAttribute(personaEClass, PERSONA__NOMBRE_PERSONA);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getDiagrama_Persona(), this.getPersona(), null, "persona", null, 0, -1, Diagrama.class,
		...
		initEAttribute(getPersona_NombrePersona(), ecorePackage.getEString(), "nombrePersona", null, 0, 1,
